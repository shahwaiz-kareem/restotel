...
import { fetchContactInfo, fetchSettings } from "@/utils/fetchers";
import FoodCatalog from "@/components/landing/FoodCatalog";
import RoomSlider from "@/components/landing/RoomSlider";
...
import StoryCanvas from "@/components/landing/StoryCanvas";
...
export default async function LandingPage() {
  ...
  try {
    ...
    console.error("Failed to load settings for Navbar.");
  }
  ...
  return (
    <>
      ...
      <Link
        ...
        }&text=Hi%2C+I+would+like+to+inquire+about+${
          settings?.brandName || "it"
        }.+Can+you+kindly+tell+me+about&type=phone_number&app_absent=0`}
        target="_blank"
        rel="noreferrer noopener"
        className="fixed bottom-5 right-5 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]"
      >
